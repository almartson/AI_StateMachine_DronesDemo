...
namespace DroneBadPracticesNamespace
{

    public class DroneBadPractices : MonoBehaviour
    {
        ...
        private DroneBadPractices _target;
                ...
                case DroneState.Wander:
                    {
                        ...
                        {
                            _target = targetToAggro.GetComponent<DroneBadPractices>();
        ...
        private Transform CheckForAggro()
        {
            ...
            for (var i = 0; i < 24; i++)
            {
                ...
                {
                    var drone = hit.collider.GetComponent<DroneBadPractices>();
                    if (drone != null && drone.Team != gameObject.GetComponent<DroneBadPractices>().Team)
                    {
...
}//End namespace DroneBadPracticesNamespace
